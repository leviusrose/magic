...
// 「どこに行けばいいか」を小さいアリーナ図 8 枚に分けて、時系列で 4 枚 × 2 段に並べる。
// magic/dmp4 (横 1 行版) と中身は同じで、並べ方だけが違う (PANEL_ROWS と styles.css のグリッド)。
// 上段が ①〜④ (前半)、下段が ⑤〜⑧ (後半) = 攻略マクロの ┃ の切れ目と同じ。
//
// ■ 真偽(本当/嘘)の判定
...
(function () {
  ...
  var PANEL_ROWS = 2;        // 何段に並べるか (styles.css のグリッドと揃える。1段版は magic/dmp4)
